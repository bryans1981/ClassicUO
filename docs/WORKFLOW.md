...
- 2026-04-21: Browser websocket receive now clears the tracked receive task when the loop exits on its own, so disconnect/reconnect state does not keep a stale completed task around.
