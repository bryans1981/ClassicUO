...
- 2026-04-23: Batch size preference updated for the remaining browser cleanup work: prefer larger feature-sized batches instead of one-item-at-a-time follow-ups unless a blocker or test failure requires a stop.
- 2026-04-23: Focus rule updated: only work on items that directly move the live browser application toward viability; non-blocking cleanup should be recorded separately and deferred until after the product is functional.
