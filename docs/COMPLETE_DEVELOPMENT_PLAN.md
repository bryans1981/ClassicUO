...
- The latest game-loop poll still does not observe an open browser socket even though the proxy logs the browser connection, so the transport bridge remains the active blocker.
